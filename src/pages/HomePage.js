  ...
  const features = [
    {
      ...
      description:
        "Get instant support and guidance from our AI-powered chatbot available 24/7",
    },
    {
      icon: Calendar,
      title: "Book Counselling Sessions",
      description:
        "Schedule one-on-one sessions with licensed mental health professionals",
    },
    {
      icon: Users,
      title: "Community Forum",
      description:
        "Connect with peers, join support groups, and share experiences safely",
    },
    {
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        "Take assessments to better understand your mental health needs",
    },
    {
      icon: Heart,
      title: "Mood Tracking",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl text-purple-100 mb-8 max-w-3xl mx-auto">
              A comprehensive platform designed specifically for students to
              access mental health resources, connect with counsellors, and
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 MindMate. Supporting student mental health with care
              and compassion.
            </p>
          </div>
        </div>
