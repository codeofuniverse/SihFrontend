...
const ChatbotPage = () => {
      ...
      >
        ...
        {isBot && (
          <div className="flex items-start max-w-xs md:max-w-md">
            ...
            <div className="p-4 shadow-md bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-b-xl rounded-tr-xl">
              <p className="whitespace-pre-wrap">{message.content}</p>
              <div className="text-xs mt-2 text-gray-500 dark:text-gray-400 text-right">
        ...
        {!isBot && (
          <div className="flex items-start max-w-xs md:max-w-md">
            <div className="p-4 shadow-md bg-purple-600 text-white rounded-t-xl rounded-bl-xl">
              <p className="whitespace-pre-wrap">{message.content}</p>
              <div className="text-xs mt-2 text-purple-200 text-right">
                {message.timestamp.toLocaleTimeString([], {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
  ...
  return (
    <div className="flex  flex-col h-100vh  bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4 md:p-8">
      ...
      <Card className="flex-1 flex flex-col max-w-4xl w-full mx-auto shadow-lg">
        <CardContent className="p-0 flex flex-col flex-1">
          ...
          <div className="p-4 md:p-6 border-t border-gray-200 dark:border-blue-700">
